...
export default registerAs('oauth2', () => {
  return {
    ...
    google_user_profile_url: process.env.OAUTH2_GOOGLE_USER_PROFILE_API_URL,
    ...
    naver_user_profile_api: process.env.OAUTH2_NAVER_USER_PROFILE_API_URL,
    ...
    kakao_token_url: process.env.OAUTH2_KAKAO_TOKEN_URL,
    kakao_scope: process.env.OAUTH2_KAKAO_SCOPE,
    kakao_user_profile_url: process.env.OAUTH2_KAKAO_USER_PROFILE_API_URL,
  };
});
