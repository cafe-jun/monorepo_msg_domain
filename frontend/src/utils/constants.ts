...
export const NOT_SUPPORT_USER_MESSAGE =
...
export const MediaErrorType: MediaError = {
  ...
  NotFoundError:
    "연결된 디바이스가 없어요. 화상 통화를 위해서 마이크와 카메라 연결이 필요해요!",
...
export const zelloGitHubURL =
  "https://github.com/boostcampwm-2022/web37-ZelloDraw";
